# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2018-07-05 06:29
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('mcqtest', '0008_auto_20180705_1155'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quizgiven', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mcqtest.GiveQuiz')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mcqtest.Student')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='givequiz',
            name='quizname',
            field=models.ManyToManyField(to='mcqtest.Quiz'),
        ),
        migrations.AddField(
            model_name='givequiz',
            name='student',
            field=models.ManyToManyField(to='mcqtest.Student'),
        ),
    ]
